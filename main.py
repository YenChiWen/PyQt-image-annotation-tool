...
def autoSelectFolder(root):
    allFolders = glob.glob(root)
    selectedFolder = ""
    count_with_unfinished = 0
    for folder in allFolders:
        ...
        for f in files:
            ...
            if os.path.isfile(fileName):                
                ...
                count_with_unfinished = count_with_unfinished + 1
                break
    print("Number of unlabeled folders: ", count_with_unfinished)
...
def get_img_paths(dir, extensions=('.jpg', '.png', '.jpeg')):
    ...
    #### modify by yen
    # allFolders = glob.glob( os.path.join(dir,"*/face_croped") )
    # for folder in allFolders:
...
class SetupWindow(QWidget):
    ...
    def init_ui(self):
        ...
        selectedFolder = autoSelectFolder("C:\\Users\\s1618\\Desktop\\DMS_dataset\\dataset_from_video\\*\\face_croped")
        if selectedFolder == "":
            print("all folder were labeled")
            sys.exit()

        self.selected_folder_label.setText(selectedFolder)
        self.selected_folder = selectedFolder
    ...
    def pick_new(self):
        ...
        """
        dialog = QFileDialog()
        folder_path = dialog.getExistingDirectory(None, "Select Folder", "../output_from_originalData")

        # 
        folder_path = os.path.join(folder_path, "face_croped")
    ...
    def pick_labels_file(self):
        ...
        # if fileName:
        fileName = 'C:/Users/s1618/Desktop/DMS_dataset/PyQt-image-annotation-tool/labels.txt.txt'
...
class LabelerWindow(QWidget):
    ...
    def show_next_image(self):
        ...
        # change button color if this is last image in dataset
            ...
            self.generate_csv("assigned_classes")
            app.exit( -99 )
